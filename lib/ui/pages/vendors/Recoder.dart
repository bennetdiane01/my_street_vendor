...
/// Example app.
class SimpleRecorderw extends StatefulWidget {
  @override
  _SimpleRecorderwState createState() => _SimpleRecorderwState();
}

class _SimpleRecorderwState extends State<SimpleRecorderw> {
